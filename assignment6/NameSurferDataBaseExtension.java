...
public class NameSurferDataBaseExtension implements NameSurferConstantsExtension {
	...
	public NameSurferDataBaseExtension(String filename) {
		try {
			...
			while (true) {
				...
				NameSurferEntryExtension currentEntry = new NameSurferEntryExtension(currentLine);
	...
	private Map<String, NameSurferEntryExtension> dataBase = new HashMap<String, NameSurferEntryExtension>();
}
